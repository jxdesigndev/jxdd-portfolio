...
target = r'/\* ── THE HUB \(NEW ABOUT PAGE\).*?(?=/\* ── INTERIOR VIEWS)'

new_css = """/* ── THE HUB (STRICT DBX GRID) ── */
.dbx-hub-view {
...
css = re.sub(target, new_css, css, flags=re.DOTALL)
with open('style.css', 'w') as f:
    f.write(css)

print("style.css updated strictly.")
